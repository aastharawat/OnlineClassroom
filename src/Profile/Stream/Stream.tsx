...
import { streamheader, StyledLink, StyledBox, StyledText, StyledCommunicateBox } from './stream.style';
    ...
    return(
        ...
        <Grid container direction="row" css = {css`padding-top: 3%;`}>
            ...
            <Grid xs={9}>
                ...
                <Grid >
                {!inputPost.length? 
                    <StyledBox css={css`height:10%`}>
                    <StyledCommunicateBox css={css`font-size: 1.5rem; color: #1967d2;`}>Communicate with your class here</StyledCommunicateBox>
                    <StyledCommunicateBox>Create and schedule announcements</StyledCommunicateBox>
                    <StyledCommunicateBox>Respond to student posts</StyledCommunicateBox>
                    </StyledBox>
                :
